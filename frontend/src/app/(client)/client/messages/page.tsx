...
export default function ClientMessagesPage() {
  ...
  }, [projectIdQuery, recipientIdQuery, refreshThreads, router, searchParams]);
  ...
  }, [refreshMessages, refreshThreads, threads]);
  ...
  }, [realtimeEnabled, refreshMessages, refreshThreads, selectedThreadId]);
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-4 px-4 py-5 md:grid-cols-[300px_minmax(0,1fr)] md:px-6">
        <aside className="rounded-xl border border-neutral-200 bg-white p-3">
          <div className="mb-3 flex items-center justify-between">
            <h1 className="text-sm font-semibold uppercase tracking-[0.12em] text-neutral-500">Messages</h1>
          ...
          {!loadingThreads && threads.length === 0 ? (
            <p className="text-sm text-neutral-500">No conversations yet. Open a project and click Message.</p>
          ) : null}
